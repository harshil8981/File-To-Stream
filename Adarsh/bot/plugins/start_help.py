...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://t.me/HP_Bot_discuss_group'>CLICK HERE FOR SUPPORT </a></b>",
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Support](https://t.me/HP_Bot_discuss_group).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ Owner", url="t.me/Mrkiller_1109")],
                [InlineKeyboardButton("💥 Support Us", url="t.me/Hpbot_update")]
            ]
        )
    )
